...
var (
	...
	ERR_CODE_APPID_EXIST = 3000
	ERR_STR_APPID_EXIST  = "appid exist"

	ERR_CODE_APPID_NOT_EXIST = 3001
	ERR_STR_APPID_NOT_EXIST  = "appid not exist"
...
func init() {
	...
	errMap[ERR_CODE_APPID_EXIST] = ERR_STR_APPID_EXIST
	errMap[ERR_CODE_APPID_NOT_EXIST] = ERR_STR_APPID_NOT_EXIST
}
